...
import { Mail, Lock, Eye, EyeOff, Hexagon, Loader2 } from 'lucide-react';
                ...
                <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-2xl rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-white/20 dark:border-gray-700 p-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.button
                            ...
                            className="w-full py-3 bg-gradient-to-r from-primary-600 to-indigo-600 hover:from-primary-700 hover:to-indigo-700 text-white rounded-xl font-semibold flex items-center justify-center gap-2 transition-all shadow-lg shadow-primary-500/30 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {status === 'loading' ? <Loader2 size={20} className="animate-spin" /> : 'Sign In'}
                        </motion.button>
                    </form>
